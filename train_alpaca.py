...
from transformers import BloomForCausalLM, BloomTokenizerFast, AutoConfig, AutoModelForCausalLM
...
#    model, model_name, device_map="auto", no_split_module_classes=["BloomBlock"]
#)
